...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        const SecondUser = message.mentions.members.second() || message.guild.members.cache.get(args[1])
        ...
        const Embed = new Discord.MessageEmbed()
            ...
            .setDescription(`${FirstUser} + ${SecondUser} = ${FirstUsernameSplit}${SecondUsernameSplit}`)
            .setColor(0xFAFAFA)
