...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        const Field1 = ["Carpenter", "Engineer", "Housewife", "Manga Artist", "Slave", "President", "Cashier", "Manager", "Driver", "Plumber", "Electrician", "YouTuber", "Gold Digger", "CEO", "Construction Worker", "Mafia Boss"]
